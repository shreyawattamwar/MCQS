...
public class ui4_c implements ActionListener{
...
//			c.setBackground(Color.pink);
			...
			frame.setTitle("Engineering Mathematics");
			frame.add(panel);
		...
		public void actionPerformed(ActionEvent e) {
			...
			else if(e.getSource()==b2)
			{
				try
				{
					Desktop.getDesktop().open(new java.io.File("File/MP_MCQ_Unit 2.pdf"));
		...
		//	        new ui5();
			...
			else if(e.getSource()==b3)
			{
				try
				{
					Desktop.getDesktop().open(new java.io.File("File/MP_Unit3_MCQ.txt"));
		...
		//		new ui5();
			...
			else if(e.getSource()==b4)
			{
				try
				{
					Desktop.getDesktop().open(new java.io.File("File/MCQ_Unit 4.txt"));
