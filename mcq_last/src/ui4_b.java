...
public class ui4_b implements ActionListener{
...
//		c.setBackground(Color.pink);
	...
	public void actionPerformed(ActionEvent e) {
	    ...
	    if( e.getSource()==b1)
		{
			try
			{
				Desktop.getDesktop().open(new java.io.File("File/CG_unit1.pdf"));
		...
		else if(e.getSource()==b2)
		{
			try
			{
				Desktop.getDesktop().open(new java.io.File("File/CG__Unit2.pdf"));
...
//		        new ui5();
		...
		else if(e.getSource()==b3)
		{
			try
			{
				Desktop.getDesktop().open(new java.io.File("File/CG_Unit3.txt"));
...
//			new ui5();
		...
		else if(e.getSource()==b4)
		{
			try
			{
				Desktop.getDesktop().open(new java.io.File("File/CG_Unit4.txt"));
...
//			new ui5();
		...
		else if(e.getSource()==b5)
		{
			try
			{
				Desktop.getDesktop().open(new java.io.File("File/CG_Unit4.pdf"));
